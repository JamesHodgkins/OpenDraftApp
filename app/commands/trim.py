...
from app.entities.base import _geo_angle_on_arc, _geo_pt_seg_dist
...
def _copy_style(source: BaseEntity) -> dict:
    """Extract style kwargs to pass to a new entity constructor."""
    return dict(layer=source.layer, color=source.color,
                line_weight=source.line_weight, line_style=source.line_style)
